...
fun main() {
    ...
    println(getRootMonkeyNumber("src/main/kotlin/day21/test.txt"))
    println(getRootMonkeyNumber("src/main/kotlin/day21/input.txt"))

    tryRootEqualityNumbers("src/main/kotlin/day21/test.txt", 0L, 500L)
    tryRootEqualityNumbers2("src/main/kotlin/day21/input.txt")

}

fun getRootMonkeyNumber(fileName: String): Long? {
...
fun tryRootEqualityNumbers(fileName: String, start: Long, end: Long) {
    val input = readStringFile(fileName)
    val monkeys: MutableMap<String, Monkey> = mutableMapOf()
...
fun tryRootEqualityNumbers2(fileName: String) {
    val input = readStringFile(fileName)
    val monkeys: MutableMap<String, Monkey> = mutableMapOf()
