...
fun main() {
    ...
    println(countUncoveredFaces("src/main/kotlin/day18/test.txt"))
    println(countUncoveredFaces("src/main/kotlin/day18/input.txt"))

    println(countOutsideFaces("src/main/kotlin/day18/test.txt"))
    println(countOutsideFaces("src/main/kotlin/day18/input.txt"))
}

fun countUncoveredFaces(fileName: String): Int {
...
fun countOutsideFaces(fileName: String): Int {
    val input = readStringFile(fileName)
