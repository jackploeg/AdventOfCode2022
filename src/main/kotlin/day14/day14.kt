...
fun main() {
    ...
    println(countFallingSand("src/main/kotlin/day14/test.txt"))
    println(countFallingSand("src/main/kotlin/day14/input.txt"))

    println(countFallingSand("src/main/kotlin/day14/test.txt", true))
    println(countFallingSand("src/main/kotlin/day14/input.txt", true))
}
