...
fun main() {
    ...
    println(shortestPath("src/main/kotlin/day12/input.txt"))

    println(shortestPath("src/main/kotlin/day12/test.txt", true))
    println(shortestPath("src/main/kotlin/day12/input.txt", true))
}
