...
fun main() {
    ...
    println(occupiedSpaces(10, "src/main/kotlin/day15/test.txt"))
    println(occupiedSpaces(2000000, "src/main/kotlin/day15/input.txt"))

    println(unoccupiedSpaceFrequency(20, "src/main/kotlin/day15/test.txt"))
    println(unoccupiedSpaceFrequency(4000000, "src/main/kotlin/day15/input.txt"))
}

fun occupiedSpaces(row: Int, fileName: String): Int {
...
fun unoccupiedSpaceFrequency(maxIndex: Int, fileName: String): Long {
    val input = readStringFile(fileName)
