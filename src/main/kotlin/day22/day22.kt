...
fun main() {
    ...
    println("Part 1 test: ${followPath("src/main/kotlin/day22/test.txt")}")
    println("Part 1 input: ${followPath("src/main/kotlin/day22/input.txt")}")

    println("Part 2 test: ${arpitsSolutionForPart2("src/main/kotlin/day22/test.txt", 4)}")
    println("Part 2 input: ${arpitsSolutionForPart2("src/main/kotlin/day22/input.txt", 50)}")
