...
fun main() {
    println(watchThrows(20, 3L, "src/main/kotlin/day11/test.txt"))
    println(watchThrows(20, 3L, "src/main/kotlin/day11/input.txt"))

    println(watchThrows(10000, 1L, "src/main/kotlin/day11/test.txt"))
    println(watchThrows(10000, 1L, "src/main/kotlin/day11/input.txt"))
}
...
fun watchThrows(numberOfThrows: Int, reliefFactor: Long, fileName: String): BigInteger {
    ...
    return monkeys.sortedByDescending { it.inspectCount }.map { it.inspectCount }.take(2).reduce { sum, x -> sum * x }
