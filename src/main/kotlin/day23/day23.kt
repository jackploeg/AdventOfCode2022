...
fun main() {
    println(spreadElves(10, "src/main/kotlin/day23/test.txt"))
    println(spreadElves(10, "src/main/kotlin/day23/input.txt"))

    println(spreadElves(20, "src/main/kotlin/day23/test.txt"))
    println(spreadElves(900, "src/main/kotlin/day23/input.txt"))
}
